...
echo "Include /docker/conf/apache/sites-enabled_1804/*.conf" > /etc/apache2/sites-available/000-default.conf
...
checkhomelamp=`grep homelamp1804 /home/$APACHE_USER/.bashrc 2>&1`
if [[ $checkhomelamp == "" ]]; then
echo "source /docker/conf/bashrc/homelamp1804.txt" >> /home/$APACHE_USER/.bashrc
fi
